...
We take the security of Coze Studio seriously. If you discover a security vulnerability, we appreciate your help in disclosing it to us in a responsible manner.
...
- **Subject Line:** "SECURITY INCIDENT - Coze Studio"
...
**In Scope:**
- Coze Studio application code (frontend and backend)
...
**GitHub Security Advisories:** https://github.com/RemyLoveLogicAI/coze-studio/security/advisories
...
- **GitHub Security Advisories:** https://github.com/RemyLoveLogicAI/coze-studio/security/advisories
- **GitHub Releases:** https://github.com/RemyLoveLogicAI/coze-studio/releases
...
- **Email:** security@lovelogic.ai
- **GitHub Discussions:** https://github.com/RemyLoveLogicAI/coze-studio/discussions
- **Documentation:** https://github.com/RemyLoveLogicAI/coze-studio/wiki

---

**Thank you for helping keep Coze Studio and our users safe!**
